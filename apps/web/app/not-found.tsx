...
export default function NotFound() {
	...
	return (
		<div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background">
			...
			{/* Mouse follower glow */}
			<motion.div
				className="pointer-events-none fixed top-0 left-0 h-96 w-96 rounded-full bg-purple-500/20 blur-3xl"
				style={{
					x: springX,
					y: springY,
					translateX: "-50%",
			...
			<div className="relative z-10 px-4 text-center">
				...
				>
					<motion.h1
						className="relative text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600"
						animate={floatingAnimation}
					>
						404
						{/* Glowing effect behind text */}
						<motion.div
							className="absolute inset-0 -z-10 text-9xl font-bold text-purple-500 blur-2xl"
				...
				<div className="absolute left-1/2 top-1/2 -z-10 -translate-x-1/2 -translate-y-1/2">
					{[...Array(3)].map((_, i) => (
						<motion.div
							key={String(i)}
							className="absolute h-64 w-64 rounded-full border border-purple-500/20"
