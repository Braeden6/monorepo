...
const carouselItems = [
  {
    id: "about",
    title: "About Me",
    description: "My journey, skills, and philosophy on building digital products.",
    icon: User,
  ...
  },
  {
    id: "blog",
    title: "The Blog",
    description: "Thoughts on software engineering, design patterns, and the future.",
    icon: Globe,
  ...
  },
  {
    id: "projects",
    title: "Projects",
    description: "A showcase of my recent work, open source contributions, and experiments.",
    icon: Cpu,
